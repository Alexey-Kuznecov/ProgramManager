...
namespace ProgramManager.Resources
{
    class IconsOptionReader
    {
        ...
        public static ObservableCollection<ButtonExtension> GetIcons()
        {
            ...
            List<XElement> elements = _elementIconAt.ToList();
            
            // Packing an object before passing in the ViewModel.
            return InitialButtonProperties(IconAttributeRepack(elements));
        }
        /// <summary>
        /// Icon attribute repacking from xml markup to icon type.
        /// </summary>
        private static List<IconModel> IconAttributeRepack(List<XElement> elements)
        {
        ...
        /// need defined source binding on <example>Button Content="{Binding Brush}"</example> in <view cref="IconsEditor"/>.
        /// </remarks>
