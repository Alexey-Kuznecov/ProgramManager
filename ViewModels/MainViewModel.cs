...
namespace ProgramManager.ViewModels
{
    ...
    public class MainViewModel : PropertiesChanged
    {
        ...
        public MainViewModel()
        {
           ...
           this.Keyboard.Add(new KeyboardModel { Description = "Перейти на следующию строку.", Keys = "Ctrl+F1" });
           this.Keyboard.Add(new KeyboardModel { Description = "Переименовать группу.", Keys = "Ctrl+F2" });
           this.Keyboard.Add(new KeyboardModel { Description = "Создать новую строку.", Keys = "Ctrl+F3" });
        }
        ...
        /// </summary>
        public List<KeyboardModel> Keyboard { get; set; } = new List<KeyboardModel>();
        ...
        {
            Process.Start(AppDomain.CurrentDomain.BaseDirectory + "IconMaker.exe");
